...
func _ready() -> void:
    ...
    self._reload_button.toggled.connect(func(toggled: bool) -> void:
        EditorInterface.set_plugin_enabled(self._last_selection + "/plugin.cfg", toggled)
...
func _update_button_bar() -> void:
    if self._last_selection != "":
        self._reload_button.set_pressed_no_signal(EditorInterface.is_plugin_enabled(self._last_selection + "/plugin.cfg"))
